...
usr_log = pd.read_csv("/home/hadoop/Downloads/CPULOGDATA2019-10-24.csv")
...
usrlog_data.to_csv("usr_log_data.csv", index=False)
print(usrlog_data.to_csv("usr_log_data.csv", index=False))
print (usrlog_data)