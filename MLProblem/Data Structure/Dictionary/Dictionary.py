...
class Dictionary:
    ...
    """
    def generatePowerDictionary(upto):
        requiredDictionary = {}
    ...
    def remove(key,givenDictionary):
        requiredDictionary = {}
        for element in givenDictionary:
            if element == key:
                continue
    ...
    def uniqueValues(givenDictionary):
        tempList = []
    ...
    def occurenceOfCharacter(givenString):
        requiredDictionary = {}
    ...
    # def nestedDictionary(listOfKeys):
    ...
    def multipleKeys(givenDictionary):
        for element in givenDictionary:
            flag = 0
...
print(Dictionary.occurenceOfCharacter(string))
Dictionary.printTable(detail)